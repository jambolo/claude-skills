...
//!
//! This binary owns the window and exposes the compute core to the web UI as
//! a small set of commands. It contains no application logic — that lives in
//! the core crate. Keep this layer thin: translate between core types and the
//! JSON protocol the front end renders, and hand heavy work to
...
/// Ask the core for a greeting.
#[tauri::command]
fn greet(name: &str) -> Greeting {
    Greeting {
        message: @PROJECT_SNAKE@_core::greeting(name),
    }
}
